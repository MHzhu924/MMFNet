...
import numpy as np
import glob
from Z_measures import compute_ave_MAE_of_methods
import os
...
#data_dir = r'../results/DSRNet_Res/' # set the data directory
data_dir = r'../results/MFFNet/' # set the data directory
...
data_dir_1=r'../dataset/360-SOD/360-SOD-te/'
gt_dir = 'groundtruth' # set the ground truth folder name
rs_dirs = ['360-SOD'] # set the folder names of Predicted dataset
...
name_list = sorted(os.listdir(data_dir_1+gt_dir))
# print(name_list)   # ['0001.png', '0002.png', '0003.png', '0004.png', '0005.png']
gt_name_list = list(map(lambda x: os.path.join(data_dir_1+gt_dir + '/' + x), name_list))
